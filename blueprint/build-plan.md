...
- [x] 8. **Saved inputs** - persist last-used values to local storage and restore them on reload.
- [x] 9. **Responsive layout** - mobile-first styling pass so the calculator is usable at the cutting table.
